...
This function plots the comparison between our F1, precision, and recall:
We used matplotlib to generate the plots, and it takes the Precision, Recall, and F1 Score metrics from each model's test phase and groups them by metric category:
